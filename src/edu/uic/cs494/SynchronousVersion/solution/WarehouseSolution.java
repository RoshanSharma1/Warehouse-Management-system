...
import edu.uic.cs494.SynchronousVersion.Warehouse;
...
public class WarehouseSolution implements Warehouse<ShelfSolution,ItemSolution> {
    ...
    @Override
     public List<Action<ShelfSolution>> audit(ItemSolution itemSolution) {
        return itemSolution.auditLogs;
    }

    @Override
     public List<Action<ItemSolution>> audit(ShelfSolution shelfSolution) {
        return shelfSolution.auditLogs;
    }
}
